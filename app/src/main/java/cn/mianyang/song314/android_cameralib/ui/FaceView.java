...
package cn.mianyang.song314.android_cameralib.ui;
...
import cn.mianyang.song314.android_cameralib.BuildConfig;
...
public class FaceView extends View implements FocusIndicator, Rotatable {
    ...
    private final boolean LOGV = BuildConfig.DEBUG;
...
//            int rh = sn.getUncroppedRenderHeight();
            ...
            int rw = canvas.getWidth();
            int rh = canvas.getHeight();
            // Prepare the matrix.
